...
db.createCollection('test_template');
db.createCollection('test_result');
db.createCollection('test_template_statistics');
// init.js
db = db.getSiblingDB('HRLend');
...
// init.js
db = db.getSiblingDB('HRLend');
db.createCollection('user_competence_and_skill_statistic');// init.js
db = db.getSiblingDB('HRLend');
